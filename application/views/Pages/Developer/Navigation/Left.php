                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="<?=base_url()?>Developer/AccountSettings"><i class="icon-cog5"></i> Account settings</a></li>
                            <li><a href="<?=base_url()?>Developer/Logout"><i class="icon-switch2"></i> Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="sidebar-category sidebar-category-visible">
                        <div class="category-content no-padding">
                            ...
                            <ul class="navigation navigation-main navigation-accordion">
                                ...
                                <li class="<?= $nav == 'Accounts Lists' ? 'active' : ''|| $nav == 'Edit Account' ? 'active' :'' ?>"><a href="<?=base_url()?>Developer"><i class="icon-users"></i> <span>Accounts</span></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /main navigation -->
