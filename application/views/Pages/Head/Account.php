				...
				<table class="table datatable-basic table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="<?=base_url()?>Head/Edit/<?=$row->account_id?>" class="btn btn-primary btn-sm" style="border-radius: 0px;" data-popup="tooltip" data-original-title="Modify"><i class="icon-pencil7"></i></a></td>
						</tr>
						<?php } ?>
					</tbody>
				</table>
