                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li><a href="<?=base_url()?>Purchasing/AccountSettings"><i class="icon-cog5"></i> Account settings</a></li>
                            <li><a href="<?=base_url()?>Purchasing/Logout"><i class="icon-switch2"></i> Logout</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="category-content no-padding">
                            ...
                            <ul class="navigation navigation-main navigation-accordion">
                                <li class="navigation-header"><span>Main</span> <i class="icon-menu" title="Main pages"></i></li>
                                    <li class="<?= $nav == 'Request' ? 'active' : ''?>"><a href="<?=base_url()?>Purchasing"><i class="icon-hammer-wrench"></i> <span>Request</span></a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- /main navigation -->
