<div class="content-wrapper">
	...
	<div class="content">
		...
		if($this->session->flashdata('error')){
			...
			echo "<div class='alert bg-danger' style='border-radius:0px;'><button type='button' class='close' data-dismiss='alert'><span>&times;</span><span class='sr-only'>Close</span></button>".$error."</div>";
		}
		?>
		</div>
		<!-- Sidebars overview -->
			...
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">
						<form action="<?=site_url('EA/Uploads/Project/'.$project['project_id'])?>" method="POST" enctype="multipart/form-data">
							<div class="form-group">
